...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=20,
	.data={0x30,0x20,0x74,0x6f,0x20,0x31,0x30,0x30,0x20,0x50,0x57,0x4d,0x20,0x63,0x6f,0x6e,0x74,0x72,0x6f,0x6c,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_25 ) = {
	.len=19,
	.data={0x0a,0x1b,0x00,0x1e,0x3f,0x2f,0x5a,0xa2,0x99,0x10,0x9b,0xf5,0x44,0xb0,0x5e,0xc8,0xea,0x6a,0x1a,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8003,.permissions=0x803,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_26},
    ...
    {.uuid=0x8005,.permissions=0x802,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_30},
};
