...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_28 ) = {
	.len=19,
	.data={0x0a,0x1e,0x00,0x1e,0x3f,0x2f,0x5a,0xa2,0x99,0x10,0x9b,0xf5,0x44,0xb0,0x5e,0xc8,0xea,0x6a,0x1a,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_24 ) = {
	.len=19,
	.data={0x12,0x1a,0x00,0x2d,0x4b,0x46,0x05,0xe7,0x3c,0x36,0xb4,0xa9,0x43,0xf6,0x6e,0xe0,0x6d,0x78,0x13,}
};
...
uint8_t bg_gattdb_data_attribute_field_21_data[1]={0x04,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_20 ) = {
	.len=19,
	.data={0x12,0x16,0x00,0x1c,0xa3,0x81,0x56,0x0f,0xfb,0x09,0xbd,0x04,0x40,0x82,0xc0,0x27,0xbc,0x30,0x9d,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8003,.permissions=0x801,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_21},
    ...
    {.uuid=0x8004,.permissions=0x801,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_25},
    ...
    {.uuid=0x8005,.permissions=0x803,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_29},
