...
8. Then limb_flash code will be in "WRITING_TO_FILE" mode. In this mode:
   ...
   8.4 Data file is writen in CSV format, which can be imported into MS Excel.
   8.5 Data is human readable raw data, 18 columns per line. Order of the data is:
	   ...
	   - accel upper x (Not tested)
	   - accel upper y (Not tested)
	   - accel upper z (Not tested)
	   - gyro upper x (Not tested)
	   - gyro upper y (Not tested)
	   - gyro upper z (Not tested)
	   - accel lower x
	   - accel lower y
	   - accel lower z
	   - gyro lower x
