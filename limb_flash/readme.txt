...
3. On-board flash device W25Q16 is 16M-bits/2M-bytes in size, may hold data for about two minutes.
4. When write to file, 16M data on W25Q16 will generate a file about 4.5M, a 4G SD card can hold ~900 data files.
6. Attached code can be edited/compiled/downloaded using STM32CubeIDE free version:
   https://www.st.com/en/development-tools/stm32cubeide.html
7. Suggested debug interface hardware ST-LINK:
